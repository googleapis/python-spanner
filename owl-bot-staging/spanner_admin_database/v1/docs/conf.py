...
project = u"google-cloud-spanner-admin-database"
...
latex_documents = [
    (
        ...
        u"google-cloud-spanner-admin-database Documentation",
        author,
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "google-cloud-spanner-admin-database",
        "GAPIC library for Google Cloud Spanner Admin Database API",
        "APIs",
    )
]
