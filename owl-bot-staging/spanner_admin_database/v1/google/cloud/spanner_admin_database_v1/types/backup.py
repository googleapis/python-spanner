...
class Backup(proto.Message):
    ...
    encryption_information: MutableSequence[common.EncryptionInfo] = proto.RepeatedField(
        proto.MESSAGE,
        number=13,
        message=common.EncryptionInfo,
    )
    ...
    instance_partitions: MutableSequence['BackupInstancePartition'] = proto.RepeatedField(
        proto.MESSAGE,
        number=19,
