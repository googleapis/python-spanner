...
class DatabaseAdminAsyncClient:
    ...
    parse_backup_schedule_path = staticmethod(DatabaseAdminClient.parse_backup_schedule_path)
    ...
    parse_crypto_key_version_path = staticmethod(DatabaseAdminClient.parse_crypto_key_version_path)
    ...
    parse_database_role_path = staticmethod(DatabaseAdminClient.parse_database_role_path)
    ...
    parse_instance_partition_path = staticmethod(DatabaseAdminClient.parse_instance_partition_path)
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, DatabaseAdminTransport, Callable[..., DatabaseAdminTransport]]] = "grpc_asyncio",
    ...
    async def update_database_ddl(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.update_database_ddl]
    ...
    async def get_database_ddl(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.get_database_ddl]
    ...
    async def copy_backup(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.copy_backup]
    ...
    async def list_database_operations(self,
    ...
    async def list_backup_operations(self,
    ...
    async def list_database_roles(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.list_database_roles]
    ...
    async def add_split_points(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.add_split_points]
    ...
    async def internal_update_graph_operation(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[self._client._transport.internal_update_graph_operation]
