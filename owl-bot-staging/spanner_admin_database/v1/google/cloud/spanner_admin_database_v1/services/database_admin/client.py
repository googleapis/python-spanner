...
class DatabaseAdminClient(metaclass=DatabaseAdminClientMeta):
    ...
    @staticmethod
    def backup_schedule_path(project: str,instance: str,database: str,schedule: str,) -> str:
        """Returns a fully-qualified backup_schedule string."""
        return "projects/{project}/instances/{instance}/databases/{database}/backupSchedules/{schedule}".format(project=project, instance=instance, database=database, schedule=schedule, )

    @staticmethod
    def parse_backup_schedule_path(path: str) -> Dict[str,str]:
        """Parses a backup_schedule path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/instances/(?P<instance>.+?)/databases/(?P<database>.+?)/backupSchedules/(?P<schedule>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    @staticmethod
    def database_role_path(project: str,instance: str,database: str,role: str,) -> str:
        """Returns a fully-qualified database_role string."""
        return "projects/{project}/instances/{instance}/databases/{database}/databaseRoles/{role}".format(project=project, instance=instance, database=database, role=role, )

    @staticmethod
    def parse_database_role_path(path: str) -> Dict[str,str]:
        """Parses a database_role path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/instances/(?P<instance>.+?)/databases/(?P<database>.+?)/databaseRoles/(?P<role>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = DatabaseAdminClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, DatabaseAdminTransport, Callable[..., DatabaseAdminTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = DatabaseAdminClient._read_environment_variables()
        self._client_cert_source = DatabaseAdminClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = DatabaseAdminClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[DatabaseAdminTransport], Callable[..., DatabaseAdminTransport]] = (
    ...
    def list_databases(self,
            request: Optional[Union[spanner_database_admin.ListDatabasesRequest, dict]] = None,
            *,
    ...
    def create_database(self,
            request: Optional[Union[spanner_database_admin.CreateDatabaseRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
    ...
    def get_database(self,
            request: Optional[Union[spanner_database_admin.GetDatabaseRequest, dict]] = None,
            *,
    ...
    def update_database(self,
            request: Optional[Union[spanner_database_admin.UpdateDatabaseRequest, dict]] = None,
            *,
    ...
    def update_database_ddl(self,
            request: Optional[Union[spanner_database_admin.UpdateDatabaseDdlRequest, dict]] = None,
            *,
    ...
    def drop_database(self,
            request: Optional[Union[spanner_database_admin.DropDatabaseRequest, dict]] = None,
            *,
            database: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def get_database_ddl(self,
            request: Optional[Union[spanner_database_admin.GetDatabaseDdlRequest, dict]] = None,
            *,
            database: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def restore_database(self,
            request: Optional[Union[spanner_database_admin.RestoreDatabaseRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
    ...
    def list_database_operations(self,
            request: Optional[Union[spanner_database_admin.ListDatabaseOperationsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def list_database_roles(self,
            request: Optional[Union[spanner_database_admin.ListDatabaseRolesRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def add_split_points(self,
            request: Optional[Union[spanner_database_admin.AddSplitPointsRequest, dict]] = None,
            *,
            database: Optional[str] = None,
            split_points: Optional[MutableSequence[spanner_database_admin.SplitPoints]] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ...
    def create_backup_schedule(self,
            request: Optional[Union[gsad_backup_schedule.CreateBackupScheduleRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
    ...
    def update_backup_schedule(self,
            request: Optional[Union[gsad_backup_schedule.UpdateBackupScheduleRequest, dict]] = None,
            *,
            backup_schedule: Optional[gsad_backup_schedule.BackupSchedule] = None,
            update_mask: Optional[field_mask_pb2.FieldMask] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    def delete_backup_schedule(self,
            request: Optional[Union[backup_schedule.DeleteBackupScheduleRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def list_backup_schedules(self,
            request: Optional[Union[backup_schedule.ListBackupSchedulesRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def internal_update_graph_operation(self,
            request: Optional[Union[spanner_database_admin.InternalUpdateGraphOperationRequest, dict]] = None,
            *,
            database: Optional[str] = None,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, spanner_database_admin.InternalUpdateGraphOperationRequest):
            request = spanner_database_admin.InternalUpdateGraphOperationRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if database is not None:
                request.database = database
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.internal_update_graph_operation]
