...
from .base import InstanceAdminTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class InstanceAdminRestTransport(InstanceAdminTransport):
    ...
    class _CreateInstancePartition(InstanceAdminRestStub):
        ...
        def __call__(self,
            ...
            pb_request = spanner_instance_admin.CreateInstancePartitionRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _DeleteInstancePartition(InstanceAdminRestStub):
        ...
        def __call__(self,
            ...
            pb_request = spanner_instance_admin.DeleteInstancePartitionRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _ListInstanceConfigOperations(InstanceAdminRestStub):
        ...
        operations method over HTTP.
            ...
            pb_request = spanner_instance_admin.ListInstanceConfigOperationsRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _ListInstancePartitionOperations(InstanceAdminRestStub):
        ...
        operations method over HTTP.
            ...
            pb_request = spanner_instance_admin.ListInstancePartitionOperationsRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _ListInstancePartitions(InstanceAdminRestStub):
        ...
        def __call__(self,
            ...
            pb_request = spanner_instance_admin.ListInstancePartitionsRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _MoveInstance(InstanceAdminRestStub):
        def __hash__(self):
    ...
    class _UpdateInstancePartition(InstanceAdminRestStub):
        ...
        def __call__(self,
            ...
            pb_request = spanner_instance_admin.UpdateInstancePartitionRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
