...
class InstanceAdminClient(metaclass=InstanceAdminClientMeta):
    ...
    @staticmethod
    def instance_partition_path(project: str,instance: str,instance_partition: str,) -> str:
        """Returns a fully-qualified instance_partition string."""
        return "projects/{project}/instances/{instance}/instancePartitions/{instance_partition}".format(project=project, instance=instance, instance_partition=instance_partition, )

    @staticmethod
    def parse_instance_partition_path(path: str) -> Dict[str,str]:
        """Parses a instance_partition path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/instances/(?P<instance>.+?)/instancePartitions/(?P<instance_partition>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = InstanceAdminClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            InstanceAdminClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, InstanceAdminTransport, Callable[..., InstanceAdminTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = InstanceAdminClient._read_environment_variables()
        self._client_cert_source = InstanceAdminClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = InstanceAdminClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[InstanceAdminTransport], Callable[..., InstanceAdminTransport]] = (
    ...
    def list_instance_configs(self,
            request: Optional[Union[spanner_instance_admin.ListInstanceConfigsRequest, dict]] = None,
            *,
    ...
    def get_instance_config(self,
            request: Optional[Union[spanner_instance_admin.GetInstanceConfigRequest, dict]] = None,
            *,
    ...
    def create_instance_config(self,
            request: Optional[Union[spanner_instance_admin.CreateInstanceConfigRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
    ...
    def update_instance_config(self,
            request: Optional[Union[spanner_instance_admin.UpdateInstanceConfigRequest, dict]] = None,
            *,
            instance_config: Optional[spanner_instance_admin.InstanceConfig] = None,
    ...
    def delete_instance_config(self,
            request: Optional[Union[spanner_instance_admin.DeleteInstanceConfigRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def list_instance_config_operations(self,
            request: Optional[Union[spanner_instance_admin.ListInstanceConfigOperationsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, spanner_instance_admin.ListInstanceConfigOperationsRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_instance_config_operations]
    ...
    def list_instances(self,
            request: Optional[Union[spanner_instance_admin.ListInstancesRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def list_instance_partitions(self,
            request: Optional[Union[spanner_instance_admin.ListInstancePartitionsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, spanner_instance_admin.ListInstancePartitionsRequest):
    ...
    def get_instance(self,
            request: Optional[Union[spanner_instance_admin.GetInstanceRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def create_instance(self,
            request: Optional[Union[spanner_instance_admin.CreateInstanceRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
    ...
    def update_instance(self,
            request: Optional[Union[spanner_instance_admin.UpdateInstanceRequest, dict]] = None,
            *,
            instance: Optional[spanner_instance_admin.Instance] = None,
    ...
    def delete_instance(self,
            request: Optional[Union[spanner_instance_admin.DeleteInstanceRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def get_instance_partition(self,
            request: Optional[Union[spanner_instance_admin.GetInstancePartitionRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def create_instance_partition(self,
            request: Optional[Union[spanner_instance_admin.CreateInstancePartitionRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, spanner_instance_admin.CreateInstancePartitionRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_instance_partition]
    ...
    def delete_instance_partition(self,
            request: Optional[Union[spanner_instance_admin.DeleteInstancePartitionRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, spanner_instance_admin.DeleteInstancePartitionRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_instance_partition]
    ...
    def update_instance_partition(self,
            request: Optional[Union[spanner_instance_admin.UpdateInstancePartitionRequest, dict]] = None,
            *,
            instance_partition: Optional[spanner_instance_admin.InstancePartition] = None,
            field_mask: Optional[field_mask_pb2.FieldMask] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, spanner_instance_admin.UpdateInstancePartitionRequest):
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_instance_partition]
    ...
    def list_instance_partition_operations(self,
            request: Optional[Union[spanner_instance_admin.ListInstancePartitionOperationsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, spanner_instance_admin.ListInstancePartitionOperationsRequest):
            request = spanner_instance_admin.ListInstancePartitionOperationsRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if parent is not None:
                request.parent = parent
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_instance_partition_operations]
    ...
    def move_instance(self,
            request: Optional[Union[spanner_instance_admin.MoveInstanceRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, str]] = (),
