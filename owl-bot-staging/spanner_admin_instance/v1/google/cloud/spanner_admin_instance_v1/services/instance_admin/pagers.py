...
class ListInstanceConfigsAsyncPager:
    ...
    @property
    async def pages(self) -> AsyncIterator[spanner_instance_admin.ListInstanceConfigsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
...
class ListInstanceConfigOperationsPager:
    ...
    """
    def __init__(self,
            method: Callable[..., spanner_instance_admin.ListInstanceConfigOperationsResponse],
        ...
        """
        self._method = method
        self._request = spanner_instance_admin.ListInstanceConfigOperationsRequest(request)
        self._response = response
        self._retry = retry
        self._timeout = timeout
        self._metadata = metadata
    ...
    @property
    def pages(self) -> Iterator[spanner_instance_admin.ListInstanceConfigOperationsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = self._method(self._request, retry=self._retry, timeout=self._timeout, metadata=self._metadata)
...
class ListInstanceConfigOperationsAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[spanner_instance_admin.ListInstanceConfigOperationsResponse]],
            request: spanner_instance_admin.ListInstanceConfigOperationsRequest,
            response: spanner_instance_admin.ListInstanceConfigOperationsResponse,
            *,
            retry: OptionalAsyncRetry = gapic_v1.method.DEFAULT,
    ...
    @property
    async def pages(self) -> AsyncIterator[spanner_instance_admin.ListInstanceConfigOperationsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, retry=self._retry, timeout=self._timeout, metadata=self._metadata)
...
class ListInstancesAsyncPager:
    ...
    @property
    async def pages(self) -> AsyncIterator[spanner_instance_admin.ListInstancesResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, retry=self._retry, timeout=self._timeout, metadata=self._metadata)
...
class ListInstancePartitionsAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[spanner_instance_admin.ListInstancePartitionsResponse]],
            request: spanner_instance_admin.ListInstancePartitionsRequest,
            response: spanner_instance_admin.ListInstancePartitionsResponse,
            *,
            retry: OptionalAsyncRetry = gapic_v1.method.DEFAULT,
    ...
    @property
    async def pages(self) -> AsyncIterator[spanner_instance_admin.ListInstancePartitionsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, retry=self._retry, timeout=self._timeout, metadata=self._metadata)
...
class ListInstancePartitionOperationsPager:
    ...
    """
    def __init__(self,
            method: Callable[..., spanner_instance_admin.ListInstancePartitionOperationsResponse],
        ...
        """
        self._method = method
        self._request = spanner_instance_admin.ListInstancePartitionOperationsRequest(request)
        self._response = response
        self._retry = retry
        self._timeout = timeout
        self._metadata = metadata
    ...
    @property
    def pages(self) -> Iterator[spanner_instance_admin.ListInstancePartitionOperationsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = self._method(self._request, retry=self._retry, timeout=self._timeout, metadata=self._metadata)
...
class ListInstancePartitionOperationsAsyncPager:
    ...
    """
    def __init__(self,
            method: Callable[..., Awaitable[spanner_instance_admin.ListInstancePartitionOperationsResponse]],
            request: spanner_instance_admin.ListInstancePartitionOperationsRequest,
            response: spanner_instance_admin.ListInstancePartitionOperationsResponse,
            *,
            retry: OptionalAsyncRetry = gapic_v1.method.DEFAULT,
    ...
    @property
    async def pages(self) -> AsyncIterator[spanner_instance_admin.ListInstancePartitionOperationsResponse]:
        yield self._response
        while self._response.next_page_token:
            self._request.page_token = self._response.next_page_token
            self._response = await self._method(self._request, retry=self._retry, timeout=self._timeout, metadata=self._metadata)
