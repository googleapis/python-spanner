...
class InstanceAdminGrpcAsyncIOTransport(InstanceAdminTransport):
    ...
    def list_instance_config_operations(self) -> Callable[
        ...
        if 'list_instance_config_operations' not in self._stubs:
            self._stubs['list_instance_config_operations'] = self.grpc_channel.unary_unary(
    ...
    def list_instance_partition_operations(self) -> Callable[
        ...
        if 'list_instance_partition_operations' not in self._stubs:
            self._stubs['list_instance_partition_operations'] = self.grpc_channel.unary_unary(
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.move_instance: gapic_v1.method_async.wrap_method(
                self.move_instance,
                default_timeout=None,
                client_info=client_info,
            ),
