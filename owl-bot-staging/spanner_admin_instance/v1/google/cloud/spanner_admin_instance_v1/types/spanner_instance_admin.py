...
class AutoscalingConfig(proto.Message):
    ...
    asymmetric_autoscaling_options: MutableSequence[AsymmetricAutoscalingOption] = proto.RepeatedField(
        proto.MESSAGE,
        number=3,
...
class Instance(proto.Message):
    ...
    replica_compute_capacity: MutableSequence['ReplicaComputeCapacity'] = proto.RepeatedField(
        proto.MESSAGE,
        number=19,
