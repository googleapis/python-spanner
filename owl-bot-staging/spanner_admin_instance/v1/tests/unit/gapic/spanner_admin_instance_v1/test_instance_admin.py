...
def test_list_instance_configs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value._content = spanner_instance_admin.ListInstanceConfigsResponse.to_json(spanner_instance_admin.ListInstanceConfigsResponse())
...
def test_list_instance_configs_rest_bad_request(transport: str = 'rest', request_type=spanner_instance_admin.ListInstanceConfigsRequest):
    client = InstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_instance_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = spanner_instance_admin.InstanceConfig.to_json(spanner_instance_admin.InstanceConfig())
...
def test_get_instance_config_rest_bad_request(transport: str = 'rest', request_type=spanner_instance_admin.GetInstanceConfigRequest):
    client = InstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_instance_config_rest_bad_request(transport: str = 'rest', request_type=spanner_instance_admin.CreateInstanceConfigRequest):
    client = InstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_instance_config_rest_bad_request(transport: str = 'rest', request_type=spanner_instance_admin.UpdateInstanceConfigRequest):
    client = InstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_instance_config_rest_bad_request(transport: str = 'rest', request_type=spanner_instance_admin.DeleteInstanceConfigRequest):
    client = InstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_instance_config_operations_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = spanner_instance_admin.ListInstanceConfigOperationsResponse.to_json(spanner_instance_admin.ListInstanceConfigOperationsResponse())
...
def test_list_instance_config_operations_rest_bad_request(transport: str = 'rest', request_type=spanner_instance_admin.ListInstanceConfigOperationsRequest):
    client = InstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_instances_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = spanner_instance_admin.ListInstancesResponse.to_json(spanner_instance_admin.ListInstancesResponse())
...
def test_list_instances_rest_bad_request(transport: str = 'rest', request_type=spanner_instance_admin.ListInstancesRequest):
    client = InstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_instance_partitions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = spanner_instance_admin.ListInstancePartitionsResponse.to_json(spanner_instance_admin.ListInstancePartitionsResponse())
...
def test_list_instance_partitions_rest_bad_request(transport: str = 'rest', request_type=spanner_instance_admin.ListInstancePartitionsRequest):
    client = InstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_instance_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = spanner_instance_admin.Instance.to_json(spanner_instance_admin.Instance())
...
def test_get_instance_rest_bad_request(transport: str = 'rest', request_type=spanner_instance_admin.GetInstanceRequest):
    client = InstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_instance_rest_bad_request(transport: str = 'rest', request_type=spanner_instance_admin.UpdateInstanceRequest):
    client = InstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_instance_rest_bad_request(transport: str = 'rest', request_type=spanner_instance_admin.DeleteInstanceRequest):
    client = InstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_instance_partition_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = spanner_instance_admin.InstancePartition.to_json(spanner_instance_admin.InstancePartition())
...
def test_get_instance_partition_rest_bad_request(transport: str = 'rest', request_type=spanner_instance_admin.GetInstancePartitionRequest):
    client = InstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_instance_partition_rest_bad_request(transport: str = 'rest', request_type=spanner_instance_admin.CreateInstancePartitionRequest):
    client = InstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_instance_partition_rest_bad_request(transport: str = 'rest', request_type=spanner_instance_admin.DeleteInstancePartitionRequest):
    client = InstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_instance_partition_rest_bad_request(transport: str = 'rest', request_type=spanner_instance_admin.UpdateInstancePartitionRequest):
    client = InstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_instance_partition_operations_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = spanner_instance_admin.ListInstancePartitionOperationsResponse.to_json(spanner_instance_admin.ListInstancePartitionOperationsResponse())
...
def test_list_instance_partition_operations_rest_bad_request(transport: str = 'rest', request_type=spanner_instance_admin.ListInstancePartitionOperationsRequest):
    client = InstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_move_instance_rest_bad_request(transport: str = 'rest', request_type=spanner_instance_admin.MoveInstanceRequest):
    client = InstanceAdminClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
