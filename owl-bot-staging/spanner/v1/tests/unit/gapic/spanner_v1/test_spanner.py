...
def test__get_client_cert_source():
    ...
    assert SpannerClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert SpannerClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert SpannerClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert SpannerClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(SpannerClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SpannerClient))
@mock.patch.object(SpannerAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(SpannerAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = SpannerClient._DEFAULT_UNIVERSE
    default_endpoint = SpannerClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = SpannerClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert SpannerClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert SpannerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == SpannerClient.DEFAULT_MTLS_ENDPOINT
    assert SpannerClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert SpannerClient._get_api_endpoint(None, None, default_universe, "always") == SpannerClient.DEFAULT_MTLS_ENDPOINT
    assert SpannerClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == SpannerClient.DEFAULT_MTLS_ENDPOINT
    assert SpannerClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert SpannerClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        SpannerClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert SpannerClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert SpannerClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
    assert SpannerClient._get_universe_domain(None, None) == SpannerClient._DEFAULT_UNIVERSE
...
@pytest.mark.parametrize("client_class", [
    SpannerClient, SpannerAsyncClient
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    ...
    (SpannerAsyncClient, transports.SpannerGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (SpannerClient, transports.SpannerRestTransport, "rest", None),
])
def test_spanner_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_spanner_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
async def test_create_session_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        client._client._transport._wrapped_methods[client._client._transport.create_session] = mock_object
...
def test_batch_create_sessions_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.batch_create_sessions in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.batch_create_sessions] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_batch_create_sessions_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SpannerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.batch_create_sessions in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.batch_create_sessions] = mock_object
...
async def test_get_session_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.get_session] = mock_object
...
async def test_list_sessions_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.list_sessions] = mock_object
...
async def test_delete_session_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.delete_session] = mock_object
...
@pytest.mark.asyncio
async def test_execute_sql_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SpannerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.execute_sql in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.execute_sql] = mock_object
...
def test_execute_streaming_sql_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.execute_streaming_sql in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.execute_streaming_sql] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_execute_streaming_sql_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SpannerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.execute_streaming_sql in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.execute_streaming_sql] = mock_object
...
def test_execute_batch_dml_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.execute_batch_dml] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_execute_batch_dml_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SpannerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.execute_batch_dml in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.execute_batch_dml] = mock_object
...
async def test_read_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.read in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.read] = mock_object
...
@pytest.mark.asyncio
async def test_streaming_read_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SpannerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.streaming_read in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.streaming_read] = mock_object
...
def test_begin_transaction_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.begin_transaction] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_begin_transaction_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SpannerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.begin_transaction in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.begin_transaction] = mock_object
...
def test_begin_transaction_flattened():
    ...
    with mock.patch.object(
        ...
        client.begin_transaction(
            session='session_value',
            options=transaction.TransactionOptions(read_write=transaction.TransactionOptions.ReadWrite(read_lock_mode=transaction.TransactionOptions.ReadWrite.ReadLockMode.PESSIMISTIC)),
        )
        ...
        assert arg == mock_val
        arg = args[0].options
        mock_val = transaction.TransactionOptions(read_write=transaction.TransactionOptions.ReadWrite(read_lock_mode=transaction.TransactionOptions.ReadWrite.ReadLockMode.PESSIMISTIC))
        assert arg == mock_val
...
async def test_commit_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.commit in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.commit] = mock_object
...
def test_commit_flattened():
    ...
    with mock.patch.object(
        ...
        client.commit(
            ...
            single_use_transaction=transaction.TransactionOptions(read_write=transaction.TransactionOptions.ReadWrite(read_lock_mode=transaction.TransactionOptions.ReadWrite.ReadLockMode.PESSIMISTIC)),
        )
        ...
        assert arg == mock_val
        assert args[0].single_use_transaction == transaction.TransactionOptions(read_write=transaction.TransactionOptions.ReadWrite(read_lock_mode=transaction.TransactionOptions.ReadWrite.ReadLockMode.PESSIMISTIC))
...
async def test_rollback_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.rollback in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.rollback] = mock_object
...
@pytest.mark.asyncio
async def test_partition_query_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SpannerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.partition_query in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.partition_query] = mock_object
...
@pytest.mark.asyncio
async def test_partition_read_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SpannerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.partition_read in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.partition_read] = mock_object
...
def test_batch_write(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.batch_write),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
async def test_batch_write_empty_call_async():
    ...
    with mock.patch.object(
        ...
        # Designate an appropriate return value for the call.
        call.return_value = mock.Mock(aio.UnaryStreamCall, autospec=True)
        call.return_value.read = mock.AsyncMock(side_effect=[spanner.BatchWriteResponse()])
...
@pytest.mark.asyncio
async def test_batch_write_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = SpannerAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.batch_write in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_object = mock.AsyncMock()
        client._client._transport._wrapped_methods[client._client._transport.batch_write] = mock_object
...
@pytest.mark.asyncio
async def test_batch_write_async(transport: str = 'grpc_asyncio', request_type=spanner.BatchWriteRequest):
    client = SpannerAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_batch_write_flattened():
    ...
    with mock.patch.object(
        ...
        client.batch_write(
            session='session_value',
            mutation_groups=[spanner.BatchWriteRequest.MutationGroup(mutations=[mutation.Mutation(insert=mutation.Mutation.Write(table='table_value'))])],
        )
        ...
        mock_val = [spanner.BatchWriteRequest.MutationGroup(mutations=[mutation.Mutation(insert=mutation.Mutation.Write(table='table_value'))])]
        assert arg == mock_val
...
def test_create_session_rest_required_fields(request_type=spanner.CreateSessionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_session._get_unset_required_fields(jsonified_request)
...
def test_create_session_rest_unset_required_fields():
    transport = transports.SpannerRestTransport(credentials=ga_credentials.AnonymousCredentials)

    unset_fields = transport.create_session._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("database", "session", )))
...
def test_create_session_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.SpannerRestInterceptor, "post_create_session") as post, \
         mock.patch.object(transports.SpannerRestInterceptor, "pre_create_session") as pre:
...
def test_create_session_rest_bad_request(transport: str = 'rest', request_type=spanner.CreateSessionRequest):
    client = SpannerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_session_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1/{database=projects/*/instances/*/databases/*}/sessions" % client.transport._host, args[1])
...
def test_batch_create_sessions_rest_required_fields(request_type=spanner.BatchCreateSessionsRequest):
    transport_class = transports.SpannerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).batch_create_sessions._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_create_sessions_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("database", "sessionCount", )))
...
def test_batch_create_sessions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SpannerRestInterceptor, "post_batch_create_sessions") as post, \
         mock.patch.object(transports.SpannerRestInterceptor, "pre_batch_create_sessions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = spanner.BatchCreateSessionsRequest.pb(spanner.BatchCreateSessionsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = spanner.BatchCreateSessionsResponse.to_json(spanner.BatchCreateSessionsResponse())
        ...
        client.batch_create_sessions(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_batch_create_sessions_rest_bad_request(transport: str = 'rest', request_type=spanner.BatchCreateSessionsRequest):
    client = SpannerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_batch_create_sessions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{database=projects/*/instances/*/databases/*}/sessions:batchCreate" % client.transport._host, args[1])
...
def test_get_session_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/instances/sample2/databases/sample3/sessions/sample4'}
    request = request_type(**request_init)
...
def test_get_session_rest_required_fields(request_type=spanner.GetSessionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_session._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_session_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SpannerRestInterceptor, "post_get_session") as post, \
...
def test_get_session_rest_bad_request(transport: str = 'rest', request_type=spanner.GetSessionRequest):
    client = SpannerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_session_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/instances/sample2/databases/sample3/sessions/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/instances/*/databases/*/sessions/*}" % client.transport._host, args[1])
...
def test_list_sessions_rest_required_fields(request_type=spanner.ListSessionsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_sessions._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_sessions_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("filter", "pageSize", "pageToken", )) & set(("database", )))
...
def test_list_sessions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SpannerRestInterceptor, "post_list_sessions") as post, \
         mock.patch.object(transports.SpannerRestInterceptor, "pre_list_sessions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = spanner.ListSessionsResponse.to_json(spanner.ListSessionsResponse())
...
def test_list_sessions_rest_bad_request(transport: str = 'rest', request_type=spanner.ListSessionsRequest):
    client = SpannerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_session_rest_required_fields(request_type=spanner.DeleteSessionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_session._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_session_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SpannerRestInterceptor, "pre_delete_session") as pre:
        pre.assert_not_called()
...
def test_delete_session_rest_bad_request(transport: str = 'rest', request_type=spanner.DeleteSessionRequest):
    client = SpannerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_execute_sql_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'session': 'projects/sample1/instances/sample2/databases/sample3/sessions/sample4'}
    request = request_type(**request_init)
...
def test_execute_sql_rest_required_fields(request_type=spanner.ExecuteSqlRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).execute_sql._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_execute_sql_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("session", "sql", )))
...
def test_execute_sql_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SpannerRestInterceptor, "post_execute_sql") as post, \
        ...
        client.execute_sql(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_execute_sql_rest_bad_request(transport: str = 'rest', request_type=spanner.ExecuteSqlRequest):
    client = SpannerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_execute_streaming_sql_rest_required_fields(request_type=spanner.ExecuteSqlRequest):
    transport_class = transports.SpannerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).execute_streaming_sql._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_execute_streaming_sql_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SpannerRestInterceptor, "post_execute_streaming_sql") as post, \
         mock.patch.object(transports.SpannerRestInterceptor, "pre_execute_streaming_sql") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = spanner.ExecuteSqlRequest.pb(spanner.ExecuteSqlRequest())
        transcode.return_value = {
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = result_set.PartialResultSet.to_json(result_set.PartialResultSet())
        ...
        client.execute_streaming_sql(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_execute_streaming_sql_rest_bad_request(transport: str = 'rest', request_type=spanner.ExecuteSqlRequest):
    client = SpannerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_execute_batch_dml_rest_required_fields(request_type=spanner.ExecuteBatchDmlRequest):
    transport_class = transports.SpannerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).execute_batch_dml._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_execute_batch_dml_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("session", "transaction", "statements", "seqno", )))
...
def test_execute_batch_dml_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SpannerRestInterceptor, "post_execute_batch_dml") as post, \
         mock.patch.object(transports.SpannerRestInterceptor, "pre_execute_batch_dml") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = spanner.ExecuteBatchDmlResponse.to_json(spanner.ExecuteBatchDmlResponse())
        ...
        client.execute_batch_dml(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_execute_batch_dml_rest_bad_request(transport: str = 'rest', request_type=spanner.ExecuteBatchDmlRequest):
    client = SpannerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_read_rest_required_fields(request_type=spanner.ReadRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).read._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_read_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("session", "table", "columns", "keySet", )))
...
def test_read_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.read(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_read_rest_bad_request(transport: str = 'rest', request_type=spanner.ReadRequest):
    client = SpannerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_streaming_read_rest_required_fields(request_type=spanner.ReadRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).streaming_read._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_streaming_read_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SpannerRestInterceptor, "post_streaming_read") as post, \
         mock.patch.object(transports.SpannerRestInterceptor, "pre_streaming_read") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = spanner.ReadRequest.pb(spanner.ReadRequest())
        transcode.return_value = {
        ...
        client.streaming_read(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_streaming_read_rest_bad_request(transport: str = 'rest', request_type=spanner.ReadRequest):
    client = SpannerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_begin_transaction_rest_required_fields(request_type=spanner.BeginTransactionRequest):
    transport_class = transports.SpannerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).begin_transaction._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_begin_transaction_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("session", "options", )))
...
def test_begin_transaction_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SpannerRestInterceptor, "post_begin_transaction") as post, \
         mock.patch.object(transports.SpannerRestInterceptor, "pre_begin_transaction") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = spanner.BeginTransactionRequest.pb(spanner.BeginTransactionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = transaction.Transaction.to_json(transaction.Transaction())
        ...
        client.begin_transaction(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_begin_transaction_rest_bad_request(transport: str = 'rest', request_type=spanner.BeginTransactionRequest):
    client = SpannerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_begin_transaction_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'session': 'projects/sample1/instances/sample2/databases/sample3/sessions/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{session=projects/*/instances/*/databases/*/sessions/*}:beginTransaction" % client.transport._host, args[1])
...
def test_commit_rest_required_fields(request_type=spanner.CommitRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).commit._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_commit_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = commit_response.CommitResponse.to_json(commit_response.CommitResponse())
        ...
        client.commit(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_commit_rest_bad_request(transport: str = 'rest', request_type=spanner.CommitRequest):
    client = SpannerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_commit_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{session=projects/*/instances/*/databases/*/sessions/*}:commit" % client.transport._host, args[1])
...
def test_rollback_rest_required_fields(request_type=spanner.RollbackRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).rollback._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_rollback_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("session", "transactionId", )))
...
def test_rollback_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        client.rollback(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_rollback_rest_bad_request(transport: str = 'rest', request_type=spanner.RollbackRequest):
    client = SpannerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_rollback_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{session=projects/*/instances/*/databases/*/sessions/*}:rollback" % client.transport._host, args[1])
...
def test_partition_query_rest_required_fields(request_type=spanner.PartitionQueryRequest):
    transport_class = transports.SpannerRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).partition_query._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_partition_query_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SpannerRestInterceptor, "post_partition_query") as post, \
         mock.patch.object(transports.SpannerRestInterceptor, "pre_partition_query") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = spanner.PartitionResponse.to_json(spanner.PartitionResponse())
        ...
        client.partition_query(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_partition_query_rest_bad_request(transport: str = 'rest', request_type=spanner.PartitionQueryRequest):
    client = SpannerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_partition_read_rest_required_fields(request_type=spanner.PartitionReadRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).partition_read._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_partition_read_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("session", "table", "keySet", )))
...
def test_partition_read_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SpannerRestInterceptor, "post_partition_read") as post, \
         mock.patch.object(transports.SpannerRestInterceptor, "pre_partition_read") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.partition_read(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_partition_read_rest_bad_request(transport: str = 'rest', request_type=spanner.PartitionReadRequest):
    client = SpannerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_batch_write_rest_required_fields(request_type=spanner.BatchWriteRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).batch_write._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_batch_write_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("session", "mutationGroups", )))
...
def test_batch_write_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.SpannerRestInterceptor, "post_batch_write") as post, \
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = spanner.BatchWriteResponse.to_json(spanner.BatchWriteResponse())
        req.return_value._content = "[{}]".format(req.return_value._content)
        ...
        client.batch_write(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_batch_write_rest_bad_request(transport: str = 'rest', request_type=spanner.BatchWriteRequest):
    client = SpannerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_batch_write_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{session=projects/*/instances/*/databases/*/sessions/*}:batchWrite" % client.transport._host, args[1])
