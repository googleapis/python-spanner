...
def test_create_session_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SpannerRestInterceptor, "post_create_session_with_metadata") as post_with_metadata, \
...
def test_batch_create_sessions_rest_bad_request(request_type=spanner.BatchCreateSessionsRequest):
    client = SpannerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_batch_create_sessions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SpannerRestInterceptor, "post_batch_create_sessions_with_metadata") as post_with_metadata, \
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = spanner.BatchCreateSessionsResponse.to_json(spanner.BatchCreateSessionsResponse())
        req.return_value.content = return_value
        ...
        post_with_metadata.return_value = spanner.BatchCreateSessionsResponse(), metadata
...
def test_get_session_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SpannerRestInterceptor, "post_get_session_with_metadata") as post_with_metadata, \
...
def test_list_sessions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SpannerRestInterceptor, "post_list_sessions_with_metadata") as post_with_metadata, \
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = spanner.ListSessionsResponse.to_json(spanner.ListSessionsResponse())
        req.return_value.content = return_value
...
def test_execute_sql_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SpannerRestInterceptor, "post_execute_sql_with_metadata") as post_with_metadata, \
...
def test_execute_streaming_sql_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SpannerRestInterceptor, "post_execute_streaming_sql_with_metadata") as post_with_metadata, \
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = result_set.PartialResultSet.to_json(result_set.PartialResultSet())
...
def test_execute_batch_dml_rest_bad_request(request_type=spanner.ExecuteBatchDmlRequest):
    client = SpannerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_execute_batch_dml_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SpannerRestInterceptor, "post_execute_batch_dml_with_metadata") as post_with_metadata, \
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = spanner.ExecuteBatchDmlResponse.to_json(spanner.ExecuteBatchDmlResponse())
        req.return_value.content = return_value
...
def test_read_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SpannerRestInterceptor, "post_read_with_metadata") as post_with_metadata, \
...
def test_streaming_read_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SpannerRestInterceptor, "post_streaming_read_with_metadata") as post_with_metadata, \
...
def test_begin_transaction_rest_bad_request(request_type=spanner.BeginTransactionRequest):
    client = SpannerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest"
    )
...
def test_begin_transaction_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SpannerRestInterceptor, "post_begin_transaction_with_metadata") as post_with_metadata, \
...
def test_commit_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SpannerRestInterceptor, "post_commit_with_metadata") as post_with_metadata, \
        ...
        req.return_value.status_code = 200
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = commit_response.CommitResponse.to_json(commit_response.CommitResponse())
        req.return_value.content = return_value
...
def test_partition_query_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SpannerRestInterceptor, "post_partition_query_with_metadata") as post_with_metadata, \
...
def test_partition_read_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SpannerRestInterceptor, "post_partition_read_with_metadata") as post_with_metadata, \
...
def test_batch_write_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
        ...
        mock.patch.object(transports.SpannerRestInterceptor, "post_batch_write_with_metadata") as post_with_metadata, \
