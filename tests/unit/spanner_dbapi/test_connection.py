...
class TestConnection(unittest.TestCase):
    ...
    def _make_connection(self, database_dialect=DatabaseDialect.DATABASE_DIALECT_UNSPECIFIED, **kwargs):
    ...
    def test_property_current_schema_google_sql_dialect(self):
        ...
        connection = self._make_connection(database_dialect=DatabaseDialect.GOOGLE_STANDARD_SQL)
        self.assertIsInstance(connection.database, Database)
...
class _Instance(object):
    ...
    def database(self, database_id="database_id", pool=None, database_dialect=DatabaseDialect.GOOGLE_STANDARD_SQL):
        return _Database(database_id, pool, database_dialect)


class _Database(object):
    def __init__(self, database_id="database_id", pool=None, database_dialect=DatabaseDialect.GOOGLE_STANDARD_SQL):
