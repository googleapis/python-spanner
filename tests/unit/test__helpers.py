...
class Test_interval(unittest.TestCase):
    ...
    def test_interval_cases(self):
        test_cases = [
            ...
            {
                "name": "Large values",
                "interval": self.Interval(months=25, days=15, nanos=316223999999999999999),
...
class Test_parse_interval(unittest.TestCase):
    ...
    def test_parse_interval_cases(self):
        test_cases = [
            ...
            {
                "name": "missing duration specifier",
                "input": "P",
                "want_err": True
            },
            {
                "name": "missing time components",
                "input": "PT",
                "want_err": True
            },
            {
                "name": "missing unit specifier",
                "input": "P1YM",
                "want_err": True
            },
            {
