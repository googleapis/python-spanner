...
class TestMetricsExporter(unittest.TestCase):
    ...
    def test_to_metric_kind(self):
        ...
        self.assertEqual(
            CloudMonitoringMetricsExporter._to_metric_kind(metric_sum_non_monotonic),
    ...
    def test_extract_metric_labels(self):
        ...
        self.assertEqual(metric_labels["directpath_enabled"], "test-directpath-enabled")
    ...
    def test_batch_write(self):
        ...
        patch_path = (
            "google.cloud.spanner_v1.metrics.metrics_exporter.CreateTimeSeriesRequest"
        )
