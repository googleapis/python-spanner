...
async def test_list_databases_async_pager():
    client = DatabaseAdminAsyncClient(credentials=ga_credentials.AnonymousCredentials,)
...
def test_list_database_roles_from_dict():
    test_list_database_roles(request_type=dict)
...
def test_list_database_roles_flattened():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        client.list_database_roles(parent="parent_value",)
...
def test_list_database_roles_flattened_error():
    ...
    with pytest.raises(ValueError):
        client.list_database_roles(
            spanner_database_admin.ListDatabaseRolesRequest(), parent="parent_value",
        )
...
async def test_list_database_roles_flattened_async():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.list_database_roles(parent="parent_value",)
...
def test_list_database_roles_pager():
    client = DatabaseAdminClient(credentials=ga_credentials.AnonymousCredentials,)
    ...
    with mock.patch.object(
        ...
        call.side_effect = (
            ...
            spanner_database_admin.ListDatabaseRolesResponse(
                database_roles=[], next_page_token="def",
            ),
            spanner_database_admin.ListDatabaseRolesResponse(
                database_roles=[spanner_database_admin.DatabaseRole(),],
                next_page_token="ghi",
            ),
            spanner_database_admin.ListDatabaseRolesResponse(
                database_roles=[
...
def test_list_database_roles_pages():
    client = DatabaseAdminClient(credentials=ga_credentials.AnonymousCredentials,)
...
async def test_list_database_roles_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_database_roles(request={})).pages:
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token
...
def test_database_role_path():
    ...
    expected = "projects/{project}/instances/{instance}/databases/{database}/databaseRoles/{role}".format(
        project=project, instance=instance, database=database, role=role,
    )
