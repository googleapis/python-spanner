...
class TestInstanceAdminClient(object):
    ...
    def test_create_instance(self):
        ...
        expected_response = {'name': name, 'config': config, 'display_name': display_name, 'node_count': node_count}
        expected_response = spanner_instance_admin_pb2.Instance(**expected_response)
        operation = operations_pb2.Operation(name='operations/test_create_instance', done=True)
        ...
        expected_request = spanner_instance_admin_pb2.CreateInstanceRequest(parent=parent, instance_id=instance_id, instance=instance)
    ...
    def test_create_instance_exception(self):
        ...
        operation = operations_pb2.Operation(name='operations/test_create_instance_exception', done=True)
    ...
    def test_update_instance(self):
        ...
        expected_response = {'name': name, 'config': config, 'display_name': display_name, 'node_count': node_count}
        expected_response = spanner_instance_admin_pb2.Instance(**expected_response)
        operation = operations_pb2.Operation(name='operations/test_update_instance', done=True)
        operation.response.Pack(expected_response)
        ...
        assert len(channel.requests) == 1
        expected_request = spanner_instance_admin_pb2.UpdateInstanceRequest(instance=instance, field_mask=field_mask)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_update_instance_exception(self):
        # Setup Response
        error = status_pb2.Status()
        operation = operations_pb2.Operation(name='operations/test_update_instance_exception', done=True)
        operation.error.CopyFrom(error)
    ...
    def test_list_instance_configs(self):
        ...
        expected_response = spanner_instance_admin_pb2.ListInstanceConfigsResponse(**expected_response)
        ...
        assert len(channel.requests) == 1
        expected_request = spanner_instance_admin_pb2.ListInstanceConfigsRequest(parent=parent)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_get_instance_config(self):
        ...
        expected_response = spanner_instance_admin_pb2.InstanceConfig(**expected_response)
        ...
        assert len(channel.requests) == 1
        expected_request = spanner_instance_admin_pb2.GetInstanceConfigRequest(name=name)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_list_instances(self):
        ...
        expected_response = spanner_instance_admin_pb2.ListInstancesResponse(**expected_response)
        ...
        assert len(channel.requests) == 1
        expected_request = spanner_instance_admin_pb2.ListInstancesRequest(parent=parent)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_get_instance(self):
        ...
        display_name = 'displayName1615086568'
        node_count = 1539922066
        expected_response = {'name': name_2, 'config': config, 'display_name': display_name, 'node_count': node_count}
        expected_response = spanner_instance_admin_pb2.Instance(**expected_response)
