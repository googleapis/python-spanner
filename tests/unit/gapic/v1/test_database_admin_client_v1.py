...
class TestDatabaseAdminClient(object):
    ...
    def test_create_database(self):
        ...
        operation = operations_pb2.Operation(name='operations/test_create_database', done=True)
        ...
        expected_request = spanner_database_admin_pb2.CreateDatabaseRequest(parent=parent, create_statement=create_statement)
    ...
    def test_create_database_exception(self):
        ...
        operation = operations_pb2.Operation(name='operations/test_create_database_exception', done=True)
    ...
    def test_update_database_ddl(self):
        ...
        operation = operations_pb2.Operation(name='operations/test_update_database_ddl', done=True)
        operation.response.Pack(expected_response)
        ...
        assert len(channel.requests) == 1
        expected_request = spanner_database_admin_pb2.UpdateDatabaseDdlRequest(database=database, statements=statements)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_update_database_ddl_exception(self):
        # Setup Response
        error = status_pb2.Status()
        operation = operations_pb2.Operation(name='operations/test_update_database_ddl_exception', done=True)
        operation.error.CopyFrom(error)
    ...
    def test_create_backup(self):
        ...
        expected_response = {'database': database, 'name': name, 'size_bytes': size_bytes}
        expected_response = backup_pb2.Backup(**expected_response)
        operation = operations_pb2.Operation(name='operations/test_create_backup', done=True)
        operation.response.Pack(expected_response)
        ...
        assert len(channel.requests) == 1
        expected_request = backup_pb2.CreateBackupRequest(parent=parent, backup_id=backup_id, backup=backup)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_create_backup_exception(self):
        # Setup Response
        error = status_pb2.Status()
        operation = operations_pb2.Operation(name='operations/test_create_backup_exception', done=True)
        operation.error.CopyFrom(error)
    ...
    def test_restore_database(self):
        ...
        expected_response = {'name': name}
        expected_response = spanner_database_admin_pb2.Database(**expected_response)
        operation = operations_pb2.Operation(name='operations/test_restore_database', done=True)
        operation.response.Pack(expected_response)
        ...
        assert len(channel.requests) == 1
        expected_request = spanner_database_admin_pb2.RestoreDatabaseRequest(parent=parent, database_id=database_id)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_restore_database_exception(self):
        # Setup Response
        error = status_pb2.Status()
        operation = operations_pb2.Operation(name='operations/test_restore_database_exception', done=True)
        operation.error.CopyFrom(error)
    ...
    def test_list_databases(self):
        ...
        expected_response = spanner_database_admin_pb2.ListDatabasesResponse(**expected_response)
        ...
        assert len(channel.requests) == 1
        expected_request = spanner_database_admin_pb2.ListDatabasesRequest(parent=parent)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_drop_database(self):
        ...
        assert len(channel.requests) == 1
        expected_request = spanner_database_admin_pb2.DropDatabaseRequest(database=database)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_get_database_ddl(self):
        ...
        assert len(channel.requests) == 1
        expected_request = spanner_database_admin_pb2.GetDatabaseDdlRequest(database=database)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_get_backup(self):
        ...
        name_2 = 'name2-1052831874'
        size_bytes = 1796325715
        expected_response = {'database': database, 'name': name_2, 'size_bytes': size_bytes}
        expected_response = backup_pb2.Backup(**expected_response)
    ...
    def test_update_backup(self):
        ...
        assert len(channel.requests) == 1
        expected_request = backup_pb2.UpdateBackupRequest(backup=backup, update_mask=update_mask)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_list_database_operations(self):
        ...
        expected_response = spanner_database_admin_pb2.ListDatabaseOperationsResponse(**expected_response)
        ...
        assert len(channel.requests) == 1
        expected_request = spanner_database_admin_pb2.ListDatabaseOperationsRequest(parent=parent)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
