...
_TYPE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="code",
            full_name="google.spanner.v1.Type.code",
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="google.spanner.v1.Type.array_element_type",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="struct_type",
            full_name="google.spanner.v1.Type.struct_type",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
...
_STRUCTTYPE_FIELD = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="name",
            full_name="google.spanner.v1.StructType.Field.name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="type",
            full_name="google.spanner.v1.StructType.Field.type",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_STRUCTTYPE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="fields",
            full_name="google.spanner.v1.StructType.fields",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
