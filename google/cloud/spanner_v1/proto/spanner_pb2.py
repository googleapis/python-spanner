...
_GETSESSIONREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\340A\002\372A \n\036spanner.googleapis.com/Session', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
  ],
  extensions=[
  ],
  nested_types=[],
...
_EXECUTEBATCHDMLREQUEST_STATEMENT_PARAMTYPESENTRY.fields_by_name['value'].message_type = google_dot_cloud_dot_spanner__v1_dot_proto_dot_type__pb2._TYPE
...
_EXECUTEBATCHDMLREQUEST.fields_by_name['transaction'].message_type = google_dot_cloud_dot_spanner__v1_dot_proto_dot_transaction__pb2._TRANSACTIONSELECTOR
_EXECUTEBATCHDMLREQUEST.fields_by_name['statements'].message_type = _EXECUTEBATCHDMLREQUEST_STATEMENT
_EXECUTEBATCHDMLRESPONSE.fields_by_name['result_sets'].message_type = google_dot_cloud_dot_spanner__v1_dot_proto_dot_result__set__pb2._RESULTSET
...
BatchCreateSessionsRequest = _reflection.GeneratedProtocolMessageType('BatchCreateSessionsRequest', (_message.Message,), {
  ...
  Attributes:
      ...
      session_count:
          ...
          (adjusting [session_count][google.spanner.v1.BatchCreateSessio
          nsRequest.session_count] as necessary).
  """,
...
ListSessionsRequest = _reflection.GeneratedProtocolMessageType('ListSessionsRequest', (_message.Message,), {
  ...
  Attributes:
      ...
      page_token:
          ...
          ][google.spanner.v1.ListSessionsResponse.next_page_token] from
          a previous [ListSessionsResponse][google.spanner.v1.ListSessio
          nsResponse].
      filter:
...
ExecuteSqlRequest = _reflection.GeneratedProtocolMessageType('ExecuteSqlRequest', (_message.Message,), {
  ...
  Attributes:
      ...
      query_mode:
          ...
          tition_token][google.spanner.v1.ExecuteSqlRequest.partition_to
          ken] is set,
