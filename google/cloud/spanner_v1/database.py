    ...
    * :meth:`drop` the database
    ...
    def restore(self, source):
        ...
        if (
            ...
            and (
                self.encryption_config.encryption_type
    ...
    def list_tables(self, schema="_default"):
        ...
        with self.snapshot() as snapshot:
            if schema is None:
                results = snapshot.execute_sql(sql=_LIST_TABLES_QUERY.format(""))
            else:
                if self._database_dialect == DatabaseDialect.POSTGRESQL:
    ...
    def set_iam_policy(self, policy):
        ...
        api = self._instance._client.database_admin_api
        metadata = _metadata_with_prefix(self.name)
        request = iam_policy_pb2.SetIamPolicyRequest(resource=self.name, policy=policy)
