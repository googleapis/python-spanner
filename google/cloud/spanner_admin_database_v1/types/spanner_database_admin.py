...
class ListDatabaseRolesRequest(proto.Message):
    r"""The request for
    [ListDatabaseRoles][DatabaseAdmin.ListDatabaseRoles].
    ...
    Attributes:
        ...
        page_token (str):
            If non-empty, ``page_token`` should contain a
            [next_page_token][ListDatabaseRolesResponse.next_page_token]
...
class ListDatabaseRolesResponse(proto.Message):
    ...
    Attributes:
        ...
        next_page_token (str):
            ``next_page_token`` can be sent in a subsequent
            [ListDatabaseRoles][DatabaseAdmin.ListDatabaseRoles] call to
    ...
    database_roles = proto.RepeatedField(
        proto.MESSAGE, number=1, message="DatabaseRole",
    )
    next_page_token = proto.Field(proto.STRING, number=2,)
