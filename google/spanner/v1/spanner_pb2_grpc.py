...
from google.cloud.spanner_v1.types import commit_response as google_dot_spanner_dot_v1_dot_commit__response__pb2
from google.cloud.spanner_v1.types import result_set as google_dot_spanner_dot_v1_dot_result__set__pb2
from google.cloud.spanner_v1.types import spanner as google_dot_spanner_dot_v1_dot_spanner__pb2
from google.cloud.spanner_v1.types import transaction as google_dot_spanner_dot_v1_dot_transaction__pb2
...
class SpannerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CreateSession = channel.unary_unary(
                ...
                request_serializer=google_dot_spanner_dot_v1_dot_spanner__pb2.CreateSessionRequest.to_json,
                response_deserializer=google_dot_spanner_dot_v1_dot_spanner__pb2.Session.from_json,
                _registered_method=True)
        self.BatchCreateSessions = channel.unary_unary(
                '/google.spanner.v1.Spanner/BatchCreateSessions',
                request_serializer=google_dot_spanner_dot_v1_dot_spanner__pb2.BatchCreateSessionsRequest.to_json,
                response_deserializer=google_dot_spanner_dot_v1_dot_spanner__pb2.BatchCreateSessionsResponse.from_json,
                _registered_method=True)
        self.GetSession = channel.unary_unary(
                '/google.spanner.v1.Spanner/GetSession',
                request_serializer=google_dot_spanner_dot_v1_dot_spanner__pb2.GetSessionRequest.to_json,
                response_deserializer=google_dot_spanner_dot_v1_dot_spanner__pb2.Session.from_json,
                _registered_method=True)
        self.ListSessions = channel.unary_unary(
                '/google.spanner.v1.Spanner/ListSessions',
                request_serializer=google_dot_spanner_dot_v1_dot_spanner__pb2.ListSessionsRequest.to_json,
                response_deserializer=google_dot_spanner_dot_v1_dot_spanner__pb2.ListSessionsResponse.from_json,
                _registered_method=True)
        self.DeleteSession = channel.unary_unary(
                '/google.spanner.v1.Spanner/DeleteSession',
                request_serializer=google_dot_spanner_dot_v1_dot_spanner__pb2.DeleteSessionRequest.to_json,
                response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.from_json,
                _registered_method=True)
        self.ExecuteSql = channel.unary_unary(
                '/google.spanner.v1.Spanner/ExecuteSql',
                request_serializer=google_dot_spanner_dot_v1_dot_spanner__pb2.ExecuteSqlRequest.to_json,
                response_deserializer=google_dot_spanner_dot_v1_dot_result__set__pb2.ResultSet.from_json,
                _registered_method=True)
        self.ExecuteStreamingSql = channel.unary_stream(
                '/google.spanner.v1.Spanner/ExecuteStreamingSql',
                request_serializer=google_dot_spanner_dot_v1_dot_spanner__pb2.ExecuteSqlRequest.to_json,
                response_deserializer=google_dot_spanner_dot_v1_dot_result__set__pb2.PartialResultSet.from_json,
                _registered_method=True)
        self.ExecuteBatchDml = channel.unary_unary(
                '/google.spanner.v1.Spanner/ExecuteBatchDml',
                request_serializer=google_dot_spanner_dot_v1_dot_spanner__pb2.ExecuteBatchDmlRequest.to_json,
                response_deserializer=google_dot_spanner_dot_v1_dot_spanner__pb2.ExecuteBatchDmlResponse.from_json,
                _registered_method=True)
        self.Read = channel.unary_unary(
                '/google.spanner.v1.Spanner/Read',
                request_serializer=google_dot_spanner_dot_v1_dot_spanner__pb2.ReadRequest.to_json,
                response_deserializer=google_dot_spanner_dot_v1_dot_result__set__pb2.ResultSet.from_json,
                _registered_method=True)
        ...
        self.BeginTransaction = channel.unary_unary(
                ...
                request_serializer=google_dot_spanner_dot_v1_dot_spanner__pb2.BeginTransactionRequest.to_json,
                response_deserializer=google_dot_spanner_dot_v1_dot_transaction__pb2.Transaction.from_json,
                _registered_method=True)
        self.Commit = channel.unary_unary(
                '/google.spanner.v1.Spanner/Commit',
                request_serializer=google_dot_spanner_dot_v1_dot_spanner__pb2.CommitRequest.to_json,
                response_deserializer=google_dot_spanner_dot_v1_dot_commit__response__pb2.CommitResponse.from_json,
                _registered_method=True)
        self.Rollback = channel.unary_unary(
                '/google.spanner.v1.Spanner/Rollback',
                request_serializer=google_dot_spanner_dot_v1_dot_spanner__pb2.RollbackRequest.to_json,
                response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.from_json,
                _registered_method=True)
        self.PartitionQuery = channel.unary_unary(
                '/google.spanner.v1.Spanner/PartitionQuery',
                request_serializer=google_dot_spanner_dot_v1_dot_spanner__pb2.PartitionQueryRequest.to_json,
                response_deserializer=google_dot_spanner_dot_v1_dot_spanner__pb2.PartitionResponse.from_json,
                _registered_method=True)
        self.PartitionRead = channel.unary_unary(
                '/google.spanner.v1.Spanner/PartitionRead',
                request_serializer=google_dot_spanner_dot_v1_dot_spanner__pb2.PartitionReadRequest.to_json,
                response_deserializer=google_dot_spanner_dot_v1_dot_spanner__pb2.PartitionResponse.from_json,
                _registered_method=True)
        self.BatchWrite = channel.unary_stream(
                '/google.spanner.v1.Spanner/BatchWrite',
                request_serializer=google_dot_spanner_dot_v1_dot_spanner__pb2.BatchWriteRequest.to_json,
                response_deserializer=google_dot_spanner_dot_v1_dot_spanner__pb2.BatchWriteResponse.from_json,
                _registered_method=True)
...
def add_SpannerServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('google.spanner.v1.Spanner', rpc_method_handlers)
