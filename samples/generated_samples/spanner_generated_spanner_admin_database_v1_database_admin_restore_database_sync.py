...
# [START spanner_generated_spanner_admin_database_v1_DatabaseAdmin_RestoreDatabase_sync]
...
# [END spanner_generated_spanner_admin_database_v1_DatabaseAdmin_RestoreDatabase_sync]
