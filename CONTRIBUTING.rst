...
- While logged into your GitHub account, navigate to the
  ``python-spanner`` `repo`_ on GitHub.

- Fork and clone the ``python-spanner`` repository to your GitHub account by
  clicking the "Fork" button.

- Clone your fork of ``python-spanner`` from your GitHub account to your local
  computer, substituting your account username and specifying the destination
  as ``hack-on-python-spanner``.  E.g.::

   $ cd ${HOME}
   $ git clone git@github.com:USERNAME/python-spanner.git hack-on-python-spanner
   $ cd hack-on-python-spanner
...
.. _repo: https://github.com/googleapis/python-spanner
